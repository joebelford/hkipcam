...
#define kHAPAccessoryCategory_IpCamera 17
#define kHAPAccessoryCategory_VideoDoorBell 18
...
static HAPAccessory accessory = { .aid = 1,
                                  .category = kHAPAccessoryCategory_IpCamera,
                                  .name = "Acme Camera",
                                  .manufacturer = "Acme",
                                  .model = "Camera1,1",
...
HAPError HandleMicrophoneMuteRead(
        ...
        bool* value,
        void* _Nullable context HAP_UNUSED) {
    *value = accessoryConfiguration.state.microphoneMute;
...
HAPError HandleMicrophoneMuteWrite(
        ...
        void* _Nullable context HAP_UNUSED) {
    HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, value ? "true" : "false");
    if (accessoryConfiguration.state.microphoneMute != value) {
        accessoryConfiguration.state.microphoneMute = value;
...
HAPError HandleSpeakerMuteRead(
        ...
        bool* value,
        void* _Nullable context HAP_UNUSED) {
    *value = accessoryConfiguration.state.speakerMute;
    HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, *value ? "true" : "false");
...
HAPError HandleSpeakerMuteWrite(
        ...
        void* _Nullable context HAP_UNUSED) {
    HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, value ? "true" : "false");
    if (accessoryConfiguration.state.speakerMute != value) {
        accessoryConfiguration.state.speakerMute = value;
